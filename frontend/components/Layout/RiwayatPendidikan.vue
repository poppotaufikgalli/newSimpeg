...
const { pending, data: jnsDiklat, refresh} = await useLazyAsyncData('getJenisDiklat', () => CariData())
						...
						<div class="flex flex-wrap">
						  	<div class="w-full">
						  		<nav class="-me-0.5 flex flex-col">
							    	<NuxtLink class="p-2 inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:outline-none hover:text-blue-600 hover:bg-blue-200" to="/pegawai/form/RiwayatPendidikan/pendum">
							      		Pendidikan Umum
							    	</NuxtLink>
							    	<NuxtLink class="p-2 inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:outline-none hover:text-blue-600 hover:bg-blue-200" to="/pegawai/form/RiwayatPendidikan/tubel">
							      		Tugas Belajar
							    	</NuxtLink>
							    	<template v-if="jnsDiklat" v-for="(item, idx) in jnsDiklat" :key="idx">
							    		...
							    		:to="{ path: '/pegawai/form/RiwayatPendidikan/diklat/'+item.id}">
							    	  	{{item.nama}}
							    		</NuxtLink>	
							    	</template>
							  	</nav>
