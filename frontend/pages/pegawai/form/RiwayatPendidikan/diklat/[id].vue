...
const jdiklat = ref(route.params.id)
										...
										<template v-if="data" v-for="(item, idx) in data" :key="idx">
											<tr class="odd:bg-white even:bg-gray-100">
												...
												<template v-if="jdiklat == 8">
													...
													<td class="size-px px-1" style="vertical-align: top; min-width: 100px;">
														<span class="flex justify-start text-xs py-0">{{item.sebagai}}</span>
													</td>
													<td class="size-px px-1" style="vertical-align: top; min-width: 100px;">
												...
												<template v-else-if="jdiklat == 10">
													...
													<td class="size-px px-1" style="vertical-align: top; min-width: 100px;">
														<span class="flex justify-center text-xs py-0">{{$dayjs().isBefore(item.takhir, 'day') || $dayjs().isSame(item.takhir, 'day') ? 'Berlaku' : ''}}</span>
													</td>
												</template>
												<template v-else>
													<td class="size-px px-1" style="vertical-align: top; min-width: 100px;">
