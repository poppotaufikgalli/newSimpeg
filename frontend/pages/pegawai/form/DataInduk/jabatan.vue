					...
					<div class="grid sm:grid-cols-12 gap-2 gap-2.5">
						...
						<div class="sm:col-span-9">
							<div class="sm:flex gap-2">
								...
								<button type="button" class="px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-600 text-white hover:bg-green-700 disabled:opacity-50 disabled:pointer-events-none">
				  					Cari Formasi
								</button>
							</div>
						</div>
						...
						<!--<div class="sm:col-span-3">
							<label for="af-account-full-name" class="inline-block text-sm text-gray-800 mt-2.5">Formasi Jabatan</label>
						</div>-->
						<!-- End Col -->

						<!--<div class="sm:col-span-9">
							<div class="sm:flex gap-2">
								<SearchSelect id0="formasiJabatans" :dataList="formasiJabatans" keyList="id" namaList="nama" v-model="fjab"/>
							</div>
						</div>-->

						<div class="sm:col-span-3">
							<label for="af-account-full-name" class="inline-block text-sm text-gray-800 mt-2.5">Jenis Jabatan</label>
						</div>
						<!-- End Col -->
						...
						<div class="sm:col-span-2">
							<label for="af-account-full-name" class="inline-block text-sm text-gray-800 mt-2.5">Eselon</label>
						</div>
						<!-- End Col -->

						<div class="sm:col-span-3">
							<div class="sm:flex gap-2">
								<SearchSelect id0="eselons" :dataList="proxyEselons" keyList="id" namaList="nama" v-model="keselon"/>
							</div>
						</div>
						...
						<div class="sm:col-span-3">
							<label for="af-account-full-name" class="inline-block text-sm text-gray-800 mt-2.5">Nama Jabatan</label>
						</div>
						<!-- End Col -->
