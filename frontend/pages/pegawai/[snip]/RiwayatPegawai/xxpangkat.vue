...
const { pending, data, refresh} = await useLazyAsyncData('getPangkat', () => CariData())
		...
		<div class="mx-auto">
			...
			<div class="bg-white rounded-xl shadow py-4 px-6 border-t-2">
				<div class="flex justify-end mb-2">
					<NuxtLink :to="`/pegawai/${snip}/DataInduk/pangkat`" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Tambah</NuxtLink>
				</div>
				<div class="mb-8">
